...
function toggleFloat() {
  ...
  if (floatToggle) {
    ...
    floatToggle.style.transform = 'scale(1.05)';
    setTimeout(() => floatToggle.style.transform = '', 300);
  }
  updateStatus();
}
...
function toggleAnimation() {
  ...
  if (animateToggle) {
    ...
    animateToggle.style.transform = 'scale(1.05)';
    setTimeout(() => animateToggle.style.transform = '', 300);
  }
  updateStatus();
  if (isAnimating) {
    animateGoku();
...
function toggleCombat() {
  ...
  if (combatToggle) {
    ...
    combatToggle.style.transform = 'scale(1.05)';
    setTimeout(() => combatToggle.style.transform = '', 300);
  }
  updateStatus();
}
...
function toggleMiniGoku() {
  ...
  gokuBtn.style.transform = 'scale(1.1)';
  setTimeout(() => gokuBtn.style.transform = '', 300);
}
...
function updateStatus() {
  ...
  setTimeout(() => statusIndicator.style.transform = '', 300);
}
...
function powerUp() {
  ...
  if (statusIndicator) {
    ...
    setTimeout(() => statusIndicator.style.color = '', 500);
  }
}
...
function setupDragAndDrop() {
  ...
  gokuMini.addEventListener('mousedown', (e) => {
    ...
    gokuMini.style.transform = 'scale(0.95)';
  });
